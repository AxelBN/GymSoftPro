...
class HealthQuests (models.Model):
    ...
    emergency_contact = models.CharField(max_length=100, verbose_name= 'contacto de emergencia', null=True)
    emergency_number = models.IntegerField(verbose_name= 'Número de emergencia', null=True)
