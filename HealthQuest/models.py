...
class physical_evaluation (models.Model):
    ...
    right_arm = models.FloatField(verbose_name='Brazo derecho', null=True, blank=True)
    left_arm = models.FloatField(verbose_name='Brazo Izquierdo', null=True, blank=True)
    chest = models.FloatField(verbose_name='Pecho', null=True, blank=True)
    abdomen = models.FloatField(verbose_name='Abdomen', null=True, blank=True)
    hip = models.FloatField(verbose_name='Cadera', null=True, blank=True)
    right_thigh = models.FloatField(verbose_name='Muslo derecho', null=True, blank=True)
    left_thigh = models.FloatField(verbose_name='Muslo izquierdo', null=True, blank=True)
    right_calf = models.FloatField(verbose_name='Pantorrilla derecha', null=True, blank=True)
    left_calf = models.FloatField(verbose_name='Pantorrilla izquierda', null=True, blank=True)
